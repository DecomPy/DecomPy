...
define void @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %3, i8* align 16 bitcast ([9 x i32]* @main.a to i8*), i64 36, i1 false)
...
; <label>:8:                                      ; preds = %5
  ...
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i32 %12)
  br label %14
...
; <label>:17:                                     ; preds = %5
  %18 = getelementptr inbounds [9 x i32], [9 x i32]* %1, i32 0, i32 0
  call void @quickSort(i32* %18, i32 0, i32 8)
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i32 0, i32 0))
  store i32 0, i32* %2, align 4
  br label %20
...
; <label>:23:                                     ; preds = %20
  ...
  %26 = getelementptr inbounds [9 x i32], [9 x i32]* %1, i64 0, i64 %25
