...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %6, i8* align 4 bitcast ([3 x i32]* @main.a to i8*), i64 12, i1 false)
  %7 = bitcast [4 x i32]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %7, i8* align 16 bitcast ([4 x i32]* @main.b to i8*), i64 16, i1 false)
  %8 = getelementptr inbounds [3 x i32], [3 x i32]* %2, i32 0, i32 0
  %9 = getelementptr inbounds [4 x i32], [4 x i32]* %3, i32 0, i32 0
  %10 = getelementptr inbounds [7 x i32], [7 x i32]* %4, i32 0, i32 0
  call void @merge(i32* %8, i32 3, i32* %9, i32 4, i32* %10)
...
; <label>:14:                                     ; preds = %11
  ...
  %17 = getelementptr inbounds [7 x i32], [7 x i32]* %4, i64 0, i64 %16
...
; <label>:23:                                     ; preds = %11
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i32 0, i32 0))
  ret i32 0
}
