...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %3, i8* align 1 getelementptr inbounds ([15 x i8], [15 x i8]* @main.str, i32 0, i32 0), i64 15, i1 false)
  %4 = getelementptr inbounds [15 x i8], [15 x i8]* %2, i32 0, i32 0
  %5 = call i32 @insertStrAt(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0), i32 1, i32 1, i32 15, i8* %4)
  %6 = getelementptr inbounds [15 x i8], [15 x i8]* %2, i32 0, i32 0
...
declare i32 @insertStrAt(i8*, i32, i32, i32, i8*) #2
