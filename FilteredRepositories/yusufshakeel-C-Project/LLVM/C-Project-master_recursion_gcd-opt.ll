...
define i32 @main() #0 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i32* %2, i32* %3)
...
; <label>:15:                                     ; preds = %12, %0
  ...
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2, i32 0, i32 0), i32 %16, i32 %17, i32 %18)
  ret i32 0
}
