...
define i32 @main() #0 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i8* %2, i32* %3, float* %4, double* %5)
  ...
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i32 %8, i32 %9, double %11, double %12)
  ret i32 0
}
