...
define i32 @main() #0 {
  ...
  store i32 %7, i32* @slen, align 4, !tbaa !3
  %8 = call i64 @strlen(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @w, i32 0, i32 0))
  %9 = trunc i64 %8 to i32
  store i32 %9, i32* @wlen, align 4, !tbaa !3
  store i32 0, i32* @wcount, align 4, !tbaa !3
...
; <label>:10:                                     ; preds = %89, %0
  ...
  %12 = load i32, i32* @slen, align 4, !tbaa !3
...
; <label>:14:                                     ; preds = %10
  ...
  %20 = load i8, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @w, i64 0, i64 0), align 16, !tbaa !7
...
; <label>:24:                                     ; preds = %44, %23
  ...
  %26 = load i32, i32* @wlen, align 4, !tbaa !3
...
; <label>:44:                                     ; preds = %43
  ...
  %46 = add nsw i32 %45, 1
  store i32 %46, i32* @j, align 4, !tbaa !3
  br label %24

; <label>:47:                                     ; preds = %42, %24
  %48 = load i32, i32* @j, align 4, !tbaa !3
  %49 = load i32, i32* @wlen, align 4, !tbaa !3
...
; <label>:80:                                     ; preds = %71, %61, %51
  %81 = load i32, i32* @wcount, align 4, !tbaa !3
  %82 = add nsw i32 %81, 1
  store i32 %82, i32* @wcount, align 4, !tbaa !3
  %83 = load i32, i32* @j, align 4, !tbaa !3
  %84 = load i32, i32* @i, align 4, !tbaa !3
  %85 = add nsw i32 %84, %83
  store i32 %85, i32* @i, align 4, !tbaa !3
  br label %86
...
; <label>:89:                                     ; preds = %88, %87
  ...
  %91 = add nsw i32 %90, 1
  store i32 %91, i32* @i, align 4, !tbaa !3
  br label %10

; <label>:92:                                     ; preds = %10
  %93 = load i32, i32* @wcount, align 4, !tbaa !3
...
define available_externally i32 @isspace(i32) #2 {
...
; Function Attrs: inlinehint nounwind readonly ssp uwtable
define available_externally i32 @ispunct(i32) #2 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4, !tbaa !3
  %3 = load i32, i32* %2, align 4, !tbaa !3
...
; <label>:26:                                     ; preds = %24
  ...
  %28 = add nsw i32 %27, 1
  store i32 %28, i32* @i, align 4, !tbaa !3
  br label %1
