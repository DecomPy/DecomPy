...
; <label>:75:                                     ; preds = %70
  ...
  %81 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %76, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0), i8* %79, i32 %80)
  br label %82
...
; <label>:117:                                    ; preds = %114
  ...
  %123 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %118, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.2, i32 0, i32 0), i8* %121, i32 %122)
  br label %124
