; ModuleID = 'Repositories/pret-agbcc/Unfiltered/agbcc-master_libc_string_strupr.c'
source_filename = "Repositories/pret-agbcc/Unfiltered/agbcc-master_libc_string_strupr.c"
...
define available_externally i32 @islower(i32) #2 {
...
; Function Attrs: inlinehint nounwind readonly ssp uwtable
define available_externally i32 @toupper(i32) #2 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4, !tbaa !8
  %3 = load i32, i32* %2, align 4, !tbaa !8
