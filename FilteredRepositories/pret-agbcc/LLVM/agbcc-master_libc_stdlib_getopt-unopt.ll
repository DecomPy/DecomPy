; ModuleID = 'Repositories/pret-agbcc/Unfiltered/agbcc-master_libc_stdlib_getopt.c'
source_filename = "Repositories/pret-agbcc/Unfiltered/agbcc-master_libc_stdlib_getopt.c"
...
; <label>:77:                                     ; preds = %72
  %78 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8, !tbaa !7
  %79 = load i8**, i8*** %6, align 8, !tbaa !7
  %80 = getelementptr inbounds i8*, i8** %79, i64 0
  %81 = load i8*, i8** %80, align 8, !tbaa !7
  %82 = load i32, i32* @optopt, align 4, !tbaa !3
  %83 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %78, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0), i8* %81, i32 %82)
  br label %84
...
; <label>:119:                                    ; preds = %116
  %120 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8, !tbaa !7
  ...
  %125 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %120, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.2, i32 0, i32 0), i8* %123, i32 %124)
  br label %126
