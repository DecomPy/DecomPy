...
define i32 @main() #0 {
  ...
  %5 = call i32 asm "1:\0A\09l.addi    $0, $0, 0x1\0A\09l.sfeqi   $0, 0x80\0A\09l.bf      1b\0A\09l.nop\0A\09", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 %4) #2, !srcloc !3
...
; <label>:11:                                     ; preds = %0
  ...
  %13 = call i32 asm "2:\0A\09l.addi    $0, $0, 0x1\0A\09l.sfeqi   $0, 0x80\0A\09l.bf      2b\0A\09l.nop\0A\09", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 %12) #2, !srcloc !4
...
!3 = !{i32 109, i32 114, i32 147, i32 177, i32 201, i32 218}
!4 = !{i32 374, i32 379, i32 412, i32 442, i32 466, i32 483}
