; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_dpsx_w_ph.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_dpsx_w_ph.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@__func__.main = private unnamed_addr constant [5 x i8] c"main\00", align 1
@.str = private unnamed_addr constant [88 x i8] c"Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_dpsx_w_ph.c\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 242413648, i32* %7, align 4, !tbaa !3
  ...
  %18 = call { i32, i32 } asm "mthi  $0, $$ac1\0A\09mtlo  $1, $$ac1\0A\09dpsx.w.ph $$ac1, $2, $3\0A\09mfhi  $0, $$ac1\0A\09mflo  $1, $$ac1\0A\09", "=r,=r,r,r,0,1,~{dirflag},~{fpsr},~{flags}"(i32 %16, i32 %17, i32 %14, i32 %15) #2, !srcloc !7
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 238, i32 255, i32 285, i32 323, i32 353, i32 383}
