...
define i32 @main() #0 {
  ...
  %12 = call { i32, i32 } asm "mthi  $0, $$ac1\0A\09mtlo  $1, $$ac1\0A\09dpa.w.ph $$ac1, $2, $3\0A\09mfhi  $0, $$ac1\0A\09mflo  $1, $$ac1\0A\09", "=r,=r,r,r,0,1,~{dirflag},~{fpsr},~{flags}"(i32 %10, i32 %11, i32 %8, i32 %9) #2, !srcloc !3
...
; <label>:36:                                     ; preds = %35, %34
  ...
  %41 = call { i32, i32 } asm "mthi  $0, $$ac1\0A\09mtlo  $1, $$ac1\0A\09dpa.w.ph $$ac1, $2, $3\0A\09mfhi  $0, $$ac1\0A\09mflo  $1, $$ac1\0A\09", "=r,=r,r,r,0,1,~{dirflag},~{fpsr},~{flags}"(i32 %39, i32 %40, i32 %37, i32 %38) #2, !srcloc !4
...
!3 = !{i32 233, i32 250, i32 280, i32 317, i32 347, i32 377}
!4 = !{i32 641, i32 658, i32 688, i32 725, i32 755, i32 785}
