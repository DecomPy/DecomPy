...
define i32 @main() #0 {
  ...
  %13 = call i32 asm "l.add r1, r1, r0\0A\09l.addc   $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %11, i32 %12) #4, !srcloc !7
...
; <label>:17:                                     ; preds = %0
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0))
...
; <label>:19:                                     ; preds = %0
  ...
  %22 = call i32 asm "l.add r1, r1, r0\0A\09l.addc   $0, $1, $2\0A\09l.movhi  $2, 0x7fff\0A\09l.ori    $2, $2, 0xffff\0A\09l.addc   $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %20, i32 %21) #4, !srcloc !8
...
; <label>:26:                                     ; preds = %19
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0))
  store i32 -1, i32* %1, align 4
  store i32 1, i32* %6, align 4
  br label %29
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 138, i32 157, i32 206}
!8 = !{i32 415, i32 434, i32 483, i32 514, i32 549, i32 580}
