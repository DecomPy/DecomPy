...
define i32 @main() #0 {
  ...
  store i32 1880859486, i32* %2, align 4, !tbaa !3
  store i32 1880841566, i32* %5, align 4, !tbaa !3
  %10 = load i32, i32* %2, align 4, !tbaa !3
  %11 = call i32 asm "absq_s.qb $0, $1\0A\09", "=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %10) #2, !srcloc !7
...
; <label>:20:                                     ; preds = %0
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @.str, i32 0, i32 0), i32 17, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %23
...
; <label>:23:                                     ; preds = %22, %21
  store i32 -2145672354, i32* %2, align 4, !tbaa !3
  store i32 2132499806, i32* %5, align 4, !tbaa !3
  %24 = load i32, i32* %2, align 4, !tbaa !3
  %25 = call { i32, i32 } asm "absq_s.qb $0, $2\0A\09rddsp $1\0A\09", "=r,=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %24) #2, !srcloc !8
  ...
  %29 = ashr i32 %28, 20
  store i32 %29, i32* %4, align 4, !tbaa !3
...
; <label>:39:                                     ; preds = %23
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @.str, i32 0, i32 0), i32 31, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.2, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %42
...
; <label>:51:                                     ; preds = %42
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @.str, i32 0, i32 0), i32 32, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %54
