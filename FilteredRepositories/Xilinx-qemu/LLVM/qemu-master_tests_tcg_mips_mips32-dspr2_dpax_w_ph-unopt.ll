...
define i32 @main() #0 {
  ...
  %18 = call { i32, i32 } asm "mthi  $0, $$ac1\0A\09mtlo  $1, $$ac1\0A\09dpax.w.ph $$ac1, $2, $3\0A\09mfhi  $0, $$ac1\0A\09mflo  $1, $$ac1\0A\09", "=r,=r,r,r,0,1,~{dirflag},~{fpsr},~{flags}"(i32 %16, i32 %17, i32 %14, i32 %15) #2, !srcloc !7
...
; <label>:44:                                     ; preds = %43, %42
  ...
  store i32 5, i32* %6, align 4, !tbaa !3
  store i32 -250, i32* %7, align 4, !tbaa !3
  ...
  %49 = call { i32, i32 } asm "mthi  $0, $$ac1\0A\09mtlo  $1, $$ac1\0A\09dpax.w.ph $$ac1, $2, $3\0A\09mfhi  $0, $$ac1\0A\09mflo  $1, $$ac1\0A\09", "=r,=r,r,r,0,1,~{dirflag},~{fpsr},~{flags}"(i32 %47, i32 %48, i32 %45, i32 %46) #2, !srcloc !8
...
; <label>:60:                                     ; preds = %44
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @.str, i32 0, i32 0), i32 40, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %63
...
; <label>:72:                                     ; preds = %63
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([88 x i8], [88 x i8]* @.str, i32 0, i32 0), i32 41, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %75
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 233, i32 250, i32 280, i32 318, i32 348, i32 378}
!8 = !{i32 647, i32 664, i32 694, i32 732, i32 762, i32 792}
