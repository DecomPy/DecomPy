; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_openrisc_test_lf_div.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_openrisc_test_lf_div.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@.str = private unnamed_addr constant [16 x i8] c"lf.div.s error\0A\00", align 1
...
define i32 @main() #0 {
  ...
  store float 3.000000e+00, float* %5, align 4, !tbaa !3
  %11 = load float, float* %3, align 4, !tbaa !3
  %12 = load float, float* %4, align 4, !tbaa !3
  %13 = call float asm "lf.div.s    $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(float %11, float %12) #4, !srcloc !7
