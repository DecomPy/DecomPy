...
define i32 @main() #0 {
  ...
  store i32 16387, i32* %7, align 4, !tbaa !3
  ...
  %18 = call { i32, i32 } asm "mthi       $0, $$ac1\0A\09mtlo       $1, $$ac1\0A\09dpau.h.qbl $$ac1, $2, $3\0A\09mfhi       $0,   $$ac1\0A\09mflo       $1,   $$ac1\0A\09", "=r,=r,r,r,0,1,~{dirflag},~{fpsr},~{flags}"(i32 %16, i32 %17, i32 %14, i32 %15) #2, !srcloc !7
