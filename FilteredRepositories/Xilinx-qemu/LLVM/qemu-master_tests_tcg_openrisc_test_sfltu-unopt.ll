...
define i32 @main() #0 {
  ...
  %11 = call i32 asm "1:\0A\09l.addi   $0, $0, 4\0A\09l.sfltu  $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %10, i32 %9) #4, !srcloc !7
...
; <label>:17:                                     ; preds = %0
  ...
  %20 = call i32 asm "1:\0A\09l.addi    $0, $0, 1\0A\09l.sfltu  $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %19, i32 %18) #4, !srcloc !8
...
!8 = !{i32 396, i32 401, i32 432, i32 459, i32 478, i32 495}
