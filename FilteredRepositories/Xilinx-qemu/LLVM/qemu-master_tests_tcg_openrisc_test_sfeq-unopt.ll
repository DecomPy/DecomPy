; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_openrisc_test_sfeq.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_openrisc_test_sfeq.c"
...
define i32 @main() #0 {
  ...
  store i32 128, i32* %3, align 4, !tbaa !3
  store i32 2, i32* %4, align 4, !tbaa !3
  %9 = load i32, i32* %2, align 4, !tbaa !3
  %10 = load i32, i32* %3, align 4, !tbaa !3
  %11 = call i32 asm "1:\0A\09l.addi   $0, $0, 0x1\0A\09l.sfeq   $0, $1\0A\09l.bf     1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %10, i32 %9) #4, !srcloc !7
...
; <label>:15:                                     ; preds = %0
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0))
...
; <label>:17:                                     ; preds = %0
  ...
  store i32 128, i32* %3, align 4, !tbaa !3
  store i32 129, i32* %4, align 4, !tbaa !3
  %18 = load i32, i32* %2, align 4, !tbaa !3
  %19 = load i32, i32* %3, align 4, !tbaa !3
  %20 = call i32 asm "2:\0A\09l.addi   $0, $0, 0x1\0A\09l.sfeq   $0, $1\0A\09l.bf     2b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %19, i32 %18) #4, !srcloc !8
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 130, i32 135, i32 167, i32 194, i32 217, i32 234}
!8 = !{i32 417, i32 422, i32 454, i32 481, i32 504, i32 521}
