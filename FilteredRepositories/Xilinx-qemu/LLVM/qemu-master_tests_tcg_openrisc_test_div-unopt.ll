...
define i32 @main() #0 {
  ...
  store i32 288, i32* %3, align 4, !tbaa !3
  ...
  %13 = call i32 asm "l.div  $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %11, i32 %12) #4, !srcloc !7
...
; <label>:19:                                     ; preds = %0
  ...
  %22 = call i32 asm "l.div $0, $1, $0\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %21, i32 %20) #4, !srcloc !8
...
; <label>:28:                                     ; preds = %19
  ...
  %31 = call i32 asm "l.div $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %29, i32 %30) #4, !srcloc !9
...
; <label>:37:                                     ; preds = %28
  ...
  %40 = call i32 asm "l.div $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %38, i32 %39) #4, !srcloc !10
  store i32 %40, i32* %2, align 4, !tbaa !3
  store i32 0, i32* %1, align 4
  store i32 1, i32* %6, align 4
  br label %41

; <label>:41:                                     ; preds = %37, %35, %26, %17
