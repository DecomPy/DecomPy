...
define i32 @main() #0 {
  ...
  %10 = call { i32, i32 } asm "muleq_s.w.phr $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %8, i32 %9) #2, !srcloc !3
...
; <label>:37:                                     ; preds = %36, %35
  ...
  %40 = call { i32, i32 } asm "muleq_s.w.phr $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %38, i32 %39) #2, !srcloc !4
...
!3 = !{i32 204, i32 231, i32 255}
!4 = !{i32 514, i32 541, i32 565}
