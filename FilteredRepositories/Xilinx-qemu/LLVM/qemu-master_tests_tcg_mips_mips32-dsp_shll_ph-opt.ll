...
define i32 @main() #0 {
  ...
  store i32 -1610563584, i32* %5, align 4
  store i32 1, i32* %6, align 4
  %7 = load i32, i32* %3, align 4
  %8 = call { i32, i32 } asm "wrdsp $$0\0A\09shll.ph $0, $2, 0x0B\0A\09rddsp $1\0A\09", "=r,=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %7) #2, !srcloc !3
...
; <label>:35:                                     ; preds = %34, %33
  ...
  %37 = call { i32, i32 } asm "wrdsp $$0\0A\09shll.ph $0, $2, 0x01\0A\09rddsp $1\0A\09", "=r,=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %36) #2, !srcloc !4
...
; <label>:64:                                     ; preds = %63, %62
  ...
  %66 = call { i32, i32 } asm "wrdsp $$0\0A\09shll.ph $0, $2, 0x0F\0A\09rddsp $1\0A\09", "=r,=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %65) #2, !srcloc !5
...
!3 = !{i32 197, i32 208, i32 244, i32 268}
!4 = !{i32 516, i32 527, i32 563, i32 587}
!5 = !{i32 835, i32 846, i32 882, i32 906}
