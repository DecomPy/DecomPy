; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_maq_sa_w_phr.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_maq_sa_w_phr.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@__func__.main = private unnamed_addr constant [5 x i8] c"main\00", align 1
@.str = private unnamed_addr constant [89 x i8] c"Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_maq_sa_w_phr.c\00", align 1
...
define i32 @main() #0 {
  ...
  %16 = call { i32, i32 } asm "mthi $2, $$ac1\0A\09mtlo $3, $$ac1\0A\09maq_sa.w.phr $$ac1, $4, $5\0A\09mfhi $0, $$ac1\0A\09mflo $1, $$ac1\0A\09", "=r,=r,r,r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %12, i32 %13, i32 %14, i32 %15) #2, !srcloc !3
...
; <label>:40:                                     ; preds = %39, %38
  ...
  %45 = call { i32, i32, i32 } asm "mthi $3, $$ac1\0A\09mtlo $4, $$ac1\0A\09maq_sa.w.phr $$ac1, $5, $6\0A\09mfhi $0, $$ac1\0A\09mflo $1, $$ac1\0A\09rddsp $2\0A\09", "=r,=r,=r,r,r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %41, i32 %42, i32 %43, i32 %44) #2, !srcloc !4
...
!3 = !{i32 327, i32 343, i32 372, i32 413, i32 442, i32 471}
!4 = !{i32 810, i32 826, i32 855, i32 896, i32 925, i32 954, i32 978}
