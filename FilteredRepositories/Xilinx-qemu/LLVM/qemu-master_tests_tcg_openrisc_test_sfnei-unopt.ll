...
define i32 @main() #0 {
  ...
  %8 = call i32 asm "1:\0A\09l.addi   $0, $0, 3\0A\09l.sfnei  $0, 0x3\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 %7) #4, !srcloc !7
...
; <label>:14:                                     ; preds = %0
  ...
  %16 = call i32 asm "1:\0A\09l.addi   $0, $0, 1\0A\09l.sfnei  $0, 0x3\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 %15) #4, !srcloc !8
...
!8 = !{i32 358, i32 363, i32 393, i32 421, i32 440, i32 457}
