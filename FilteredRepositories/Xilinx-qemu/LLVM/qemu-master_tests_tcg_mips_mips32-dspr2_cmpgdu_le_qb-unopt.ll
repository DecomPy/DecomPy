; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_cmpgdu_le_qb.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_cmpgdu_le_qb.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@__func__.main = private unnamed_addr constant [5 x i8] c"main\00", align 1
@.str = private unnamed_addr constant [91 x i8] c"Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_cmpgdu_le_qb.c\00", align 1
...
define i32 @main() #0 {
  ...
  %14 = call { i32, i32 } asm "cmpgdu.le.qb $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %12, i32 %13) #2, !srcloc !7
...
; <label>:43:                                     ; preds = %42, %41
  store i32 293040230, i32* %3, align 4, !tbaa !3
  store i32 292581478, i32* %4, align 4, !tbaa !3
  store i32 11, i32* %6, align 4, !tbaa !3
  %44 = load i32, i32* %3, align 4, !tbaa !3
  %45 = load i32, i32* %4, align 4, !tbaa !3
  %46 = call { i32, i32 } asm "cmpgdu.le.qb $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %44, i32 %45) #2, !srcloc !8
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 203, i32 229, i32 253}
!8 = !{i32 500, i32 526, i32 550}
