...
define i32 @main() #0 {
  ...
  %14 = call { i32, i32 } asm "cmpgdu.lt.qb $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %12, i32 %13) #2, !srcloc !7
...
; <label>:43:                                     ; preds = %42, %41
  ...
  %46 = call { i32, i32 } asm "cmpgdu.lt.qb $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %44, i32 %45) #2, !srcloc !8
