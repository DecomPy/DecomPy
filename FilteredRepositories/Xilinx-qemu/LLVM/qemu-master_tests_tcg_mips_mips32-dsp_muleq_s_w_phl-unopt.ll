...
define i32 @main() #0 {
  ...
  store i32 -2147478988, i32* %4, align 4, !tbaa !3
  ...
  %16 = call { i32, i32 } asm "muleq_s.w.phl $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %14, i32 %15) #2, !srcloc !7
...
; <label>:45:                                     ; preds = %44, %43
  store i32 305437064, i32* %3, align 4, !tbaa !3
  store i32 1126275464, i32* %4, align 4, !tbaa !3
  store i32 160164200, i32* %6, align 4, !tbaa !3
  store i32 1, i32* %7, align 4, !tbaa !3
  %46 = load i32, i32* %3, align 4, !tbaa !3
  %47 = load i32, i32* %4, align 4, !tbaa !3
  %48 = call { i32, i32 } asm "muleq_s.w.phl $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %46, i32 %47) #2, !srcloc !8
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 212, i32 239, i32 263}
!8 = !{i32 530, i32 557, i32 581}
