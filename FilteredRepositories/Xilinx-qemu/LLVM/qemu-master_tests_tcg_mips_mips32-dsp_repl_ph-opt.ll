...
define i32 @main() #0 {
  ...
  store i32 29295039, i32* %3, align 4
  %4 = call i32 asm "repl.ph $0, 0x1BF\0A\09", "=r,~{dirflag},~{fpsr},~{flags}"() #2, !srcloc !3
...
; <label>:12:                                     ; preds = %0
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str, i32 0, i32 0), i32 13, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0)) #3
  unreachable
                                                  ; No predecessors!
  br label %15
...
; <label>:15:                                     ; preds = %14, %13
  store i32 33489407, i32* %3, align 4
  %16 = call i32 asm "repl.ph $0, 0x01FF\0A\09", "=r,~{dirflag},~{fpsr},~{flags}"() #2, !srcloc !4
