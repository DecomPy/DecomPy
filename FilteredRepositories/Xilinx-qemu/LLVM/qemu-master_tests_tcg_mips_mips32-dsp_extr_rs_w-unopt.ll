; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_extr_rs_w.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_extr_rs_w.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@__func__.main = private unnamed_addr constant [5 x i8] c"main\00", align 1
@.str = private unnamed_addr constant [86 x i8] c"Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_extr_rs_w.c\00", align 1
...
define i32 @main() #0 {
  ...
  %14 = call { i32, i32 } asm "mthi $2, $$ac1\0A\09mtlo $3, $$ac1\0A\09extr_rs.w $0, $$ac1, 0x03\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %12, i32 %13) #2, !srcloc !7
...
; <label>:27:                                     ; preds = %0
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([86 x i8], [86 x i8]* @.str, i32 0, i32 0), i32 21, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %30
...
; <label>:39:                                     ; preds = %30
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([86 x i8], [86 x i8]* @.str, i32 0, i32 0), i32 22, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %42
...
; <label>:42:                                     ; preds = %41, %40
  ...
  %46 = call { i32, i32 } asm "mthi $2, $$ac1\0A\09mtlo $3, $$ac1\0A\09extr_rs.w $0, $$ac1, 0x04\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %44, i32 %45) #2, !srcloc !9
...
; <label>:59:                                     ; preds = %42
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([86 x i8], [86 x i8]* @.str, i32 0, i32 0), i32 44, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %62
...
; <label>:71:                                     ; preds = %62
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([86 x i8], [86 x i8]* @.str, i32 0, i32 0), i32 45, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %74
...
; <label>:74:                                     ; preds = %73, %72
  ...
  %78 = call { i32, i32 } asm "mthi $2, $$ac1\0A\09mtlo $3, $$ac1\0A\09extr_rs.w $0, $$ac1, 0x1F\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %76, i32 %77) #2, !srcloc !11
...
; <label>:106:                                    ; preds = %105, %104
  ...
  store i32 -2147483648, i32* %6, align 4, !tbaa !3
  %108 = load i32, i32* %3, align 4, !tbaa !3
  %109 = load i32, i32* %4, align 4, !tbaa !3
  %110 = call { i32, i32 } asm "mthi $2, $$ac1\0A\09mtlo $3, $$ac1\0A\09extr_rs.w $0, $$ac1, 0x1F\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %108, i32 %109) #2, !srcloc !13
...
; <label>:123:                                    ; preds = %106
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([86 x i8], [86 x i8]* @.str, i32 0, i32 0), i32 90, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %126
...
; <label>:135:                                    ; preds = %126
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([86 x i8], [86 x i8]* @.str, i32 0, i32 0), i32 91, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %138
...
; <label>:138:                                    ; preds = %137, %136
  store i32 0, i32* %5, align 4, !tbaa !3
  %139 = load i32, i32* %5, align 4, !tbaa !3
  call void asm sideeffect "wrdsp $0\0A\09", "r,~{dirflag},~{fpsr},~{flags}"(i32 %139) #4, !srcloc !14
  store i32 -1, i32* %3, align 4, !tbaa !3
  store i32 -1, i32* %4, align 4, !tbaa !3
  store i32 0, i32* %6, align 4, !tbaa !3
  %140 = load i32, i32* %3, align 4, !tbaa !3
  %141 = load i32, i32* %4, align 4, !tbaa !3
  %142 = call { i32, i32 } asm "mthi $2, $$ac1\0A\09mtlo $3, $$ac1\0A\09extr_rs.w $0, $$ac1, 0x1F\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %140, i32 %141) #2, !srcloc !15
  ...
  %145 = load i32, i32* %5, align 4, !tbaa !3
  %146 = ashr i32 %145, 23
  %147 = and i32 %146, 1
  store i32 %147, i32* %5, align 4, !tbaa !3
  %148 = load i32, i32* %5, align 4, !tbaa !3
...
; <label>:155:                                    ; preds = %138
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([86 x i8], [86 x i8]* @.str, i32 0, i32 0), i32 113, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %158
...
; <label>:158:                                    ; preds = %157, %156
  ...
  %160 = load i32, i32* %2, align 4, !tbaa !3
...
; <label>:167:                                    ; preds = %158
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([86 x i8], [86 x i8]* @.str, i32 0, i32 0), i32 114, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %170
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 175, i32 191, i32 220, i32 260, i32 284}
!8 = !{i32 498, i32 509}
!9 = !{i32 634, i32 650, i32 679, i32 719, i32 743}
!10 = !{i32 957, i32 968}
!11 = !{i32 1103, i32 1119, i32 1148, i32 1188, i32 1212}
!12 = !{i32 1426, i32 1437}
!13 = !{i32 1572, i32 1588, i32 1617, i32 1657, i32 1681}
!14 = !{i32 1895, i32 1906}
!15 = !{i32 2032, i32 2048, i32 2077, i32 2117, i32 2141}
