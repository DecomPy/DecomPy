...
define i32 @main() #0 {
  ...
  %18 = call { i32, i32 } asm "mult $$ac1, $2, $3\0A\09mfhi $0, $$ac1\0A\09mflo $1, $$ac1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %16, i32 %17) #2, !srcloc !7
...
; <label>:29:                                     ; preds = %0
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str, i32 0, i32 0), i32 20, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %32
...
; <label>:41:                                     ; preds = %32
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str, i32 0, i32 0), i32 21, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %44
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 227, i32 247, i32 276, i32 305}
