; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_openrisc_test_sfne.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_openrisc_test_sfne.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@.str = private unnamed_addr constant [12 x i8] c"sfne error\0A\00", align 1
...
define i32 @main() #0 {
  ...
  %11 = call i32 asm "1:\0A\09l.addi   $0, $0, 3\0A\09l.sfne   $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %10, i32 %9) #4, !srcloc !7
...
; <label>:17:                                     ; preds = %0
  ...
  %20 = call i32 asm "1:\0A\09l.addi   $0, $0, 1\0A\09l.sfne   $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %19, i32 %18) #4, !srcloc !8
...
!8 = !{i32 395, i32 400, i32 430, i32 457, i32 476, i32 493}
