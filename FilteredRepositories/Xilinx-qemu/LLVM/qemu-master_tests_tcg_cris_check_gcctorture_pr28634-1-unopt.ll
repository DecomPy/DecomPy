...
; <label>:5:                                      ; preds = %2
  %6 = load i32, i32* @x, align 4, !tbaa !3
  %7 = load i32, i32* @y, align 4, !tbaa !3
  %8 = add nsw i32 %7, %6
  store i32 %8, i32* @y, align 4, !tbaa !3
  br label %2

; <label>:9:                                      ; preds = %2
  %10 = load i32, i32* @y, align 4, !tbaa !3
  %11 = load i32, i32* @x, align 4, !tbaa !3
  %12 = add nsw i32 %11, 1
