...
define i32 @main() #0 {
  ...
  store i32 -2147482629, i32* %8, align 4, !tbaa !3
  ...
  %22 = call { i32, i32, i32 } asm "mthi        $0, $$ac1\0A\09mtlo        $1, $$ac1\0A\09dpaq_s.w.ph $$ac1, $3, $4\0A\09mfhi        $0,   $$ac1\0A\09mflo        $1,   $$ac1\0A\09rddsp       $2\0A\09", "=r,=r,=r,r,r,0,1,~{dirflag},~{fpsr},~{flags}"(i32 %20, i32 %21, i32 %18, i32 %19) #2, !srcloc !7
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 285, i32 308, i32 344, i32 384, i32 422, i32 460, i32 490}
