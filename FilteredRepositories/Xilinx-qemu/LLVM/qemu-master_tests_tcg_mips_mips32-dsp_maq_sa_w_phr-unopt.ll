...
define i32 @main() #0 {
  ...
  %26 = call { i32, i32 } asm "mthi $2, $$ac1\0A\09mtlo $3, $$ac1\0A\09maq_sa.w.phr $$ac1, $4, $5\0A\09mfhi $0, $$ac1\0A\09mflo $1, $$ac1\0A\09", "=r,=r,r,r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %22, i32 %23, i32 %24, i32 %25) #2, !srcloc !7
...
; <label>:52:                                     ; preds = %51, %50
  ...
  %57 = call { i32, i32, i32 } asm "mthi $3, $$ac1\0A\09mtlo $4, $$ac1\0A\09maq_sa.w.phr $$ac1, $5, $6\0A\09mfhi $0, $$ac1\0A\09mflo $1, $$ac1\0A\09rddsp $2\0A\09", "=r,=r,=r,r,r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %53, i32 %54, i32 %55, i32 %56) #2, !srcloc !8
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 327, i32 343, i32 372, i32 413, i32 442, i32 471}
!8 = !{i32 810, i32 826, i32 855, i32 896, i32 925, i32 954, i32 978}
