; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_cris_check_time2.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_cris_check_time2.c"
...
define i32 @main() #0 {
  ...
  store i64 -1, i64* %2, align 8, !tbaa !3
  %5 = bitcast i64* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #4
  %6 = call i64 @time(i64* %2)
  store i64 %6, i64* %3, align 8, !tbaa !3
  %7 = load i64, i64* %3, align 8, !tbaa !3
  %8 = icmp eq i64 %7, -1
  br i1 %8, label %13, label %9

; <label>:9:                                      ; preds = %0
  %10 = load i64, i64* %3, align 8, !tbaa !3
  %11 = load i64, i64* %2, align 8, !tbaa !3
