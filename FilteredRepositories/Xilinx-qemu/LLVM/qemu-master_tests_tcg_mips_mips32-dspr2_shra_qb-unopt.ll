; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_shra_qb.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_shra_qb.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@__func__.main = private unnamed_addr constant [5 x i8] c"main\00", align 1
@.str = private unnamed_addr constant [86 x i8] c"Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_shra_qb.c\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 33950223, i32* %4, align 4, !tbaa !3
  %8 = load i32, i32* %3, align 4, !tbaa !3
  %9 = call i32 asm "shra.qb $0, $1, 0x03\0A\09", "=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %8) #2, !srcloc !7
...
; <label>:21:                                     ; preds = %20, %19
  ...
  store i32 -267646972, i32* %4, align 4, !tbaa !3
  %22 = load i32, i32* %3, align 4, !tbaa !3
  %23 = call i32 asm "shra.qb $0, $1, 0x03\0A\09", "=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %22) #2, !srcloc !8
