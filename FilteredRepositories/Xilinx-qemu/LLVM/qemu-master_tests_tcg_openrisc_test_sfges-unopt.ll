...
define i32 @main() #0 {
  ...
  %13 = call i32 asm "1:\0A\09l.addi   $0, $0, 1\0A\09l.sfges  $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %12, i32 %11) #4, !srcloc !7
...
; <label>:19:                                     ; preds = %0
  ...
  %23 = call i32 asm "1:\0A\09l.sub    $0, $0, $2\0A\09l.sfges  $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %21, i32 %22, i32 %20) #4, !srcloc !8
...
!8 = !{i32 415, i32 420, i32 451, i32 478, i32 497, i32 514}
