...
define i32 @main() #0 {
  ...
  store i32 -252966812, i32* %5, align 4, !tbaa !3
  %10 = load i32, i32* %4, align 4, !tbaa !3
  %11 = load i32, i32* %3, align 4, !tbaa !3
  %12 = call i32 asm "shrav.ph $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %10, i32 %11) #2, !srcloc !7
...
; <label>:24:                                     ; preds = %23, %22
  ...
  %27 = call i32 asm "shrav.ph $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %25, i32 %26) #2, !srcloc !8
