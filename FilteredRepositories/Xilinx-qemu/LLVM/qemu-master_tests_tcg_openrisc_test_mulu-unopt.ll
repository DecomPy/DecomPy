...
define i32 @main() #0 {
  ...
  %13 = call i32 asm "l.mulu    $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %11, i32 %12) #4, !srcloc !7
...
; <label>:19:                                     ; preds = %0
  ...
  %22 = call i32 asm "l.mulu    $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %20, i32 %21) #4, !srcloc !8
...
; <label>:28:                                     ; preds = %19
  ...
  %31 = call i32 asm "l.mulu    $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %29, i32 %30) #4, !srcloc !9
...
; <label>:35:                                     ; preds = %28
  %36 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0))
  store i32 -1, i32* %1, align 4
  store i32 1, i32* %6, align 4
  br label %38
