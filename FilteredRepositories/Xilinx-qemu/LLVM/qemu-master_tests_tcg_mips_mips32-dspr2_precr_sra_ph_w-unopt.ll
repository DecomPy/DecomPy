...
define i32 @main() #0 {
  ...
  %10 = call i32 asm "precr_sra.ph.w $0, $1, 0x00\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %9, i32 %8) #2, !srcloc !7
...
; <label>:19:                                     ; preds = %0
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([93 x i8], [93 x i8]* @.str, i32 0, i32 0), i32 18, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %22
...
; <label>:22:                                     ; preds = %21, %20
  ...
  %25 = call i32 asm "precr_sra.ph.w $0, $1, 0x1F\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %24, i32 %23) #2, !srcloc !8
...
; <label>:34:                                     ; preds = %22
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([93 x i8], [93 x i8]* @.str, i32 0, i32 0), i32 29, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %37
