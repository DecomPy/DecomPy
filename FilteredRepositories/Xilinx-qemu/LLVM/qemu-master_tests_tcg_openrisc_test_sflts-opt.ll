...
define i32 @main() #0 {
  ...
  %7 = call i32 asm "1:\0A\09l.addi   $0, $0, 4\0A\09l.sflts  $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %6, i32 %5) #2, !srcloc !3
...
; <label>:13:                                     ; preds = %0
  ...
  %16 = call i32 asm "1:\0A\09l.addi    $0, $0, 1\0A\09l.sflts   $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %15, i32 %14) #2, !srcloc !4
...
!4 = !{i32 396, i32 401, i32 432, i32 460, i32 479, i32 496}
