...
define i32 @main() #0 {
  ...
  store i32 66051, i32* %5, align 4
  %6 = load i32, i32* %4, align 4
  %7 = load i32, i32* %3, align 4
  %8 = call i32 asm "shrlv.qb $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %6, i32 %7) #2, !srcloc !3
...
; <label>:19:                                     ; preds = %18, %17
  ...
  %22 = call i32 asm "shrlv.qb $0, $1, $2\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %20, i32 %21) #2, !srcloc !4
