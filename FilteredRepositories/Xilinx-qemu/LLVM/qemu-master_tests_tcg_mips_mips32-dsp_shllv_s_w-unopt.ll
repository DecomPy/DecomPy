; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_shllv_s_w.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_shllv_s_w.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@__func__.main = private unnamed_addr constant [5 x i8] c"main\00", align 1
@.str = private unnamed_addr constant [86 x i8] c"Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_shllv_s_w.c\00", align 1
...
define i32 @main() #0 {
  ...
  %16 = call { i32, i32 } asm "shllv_s.w $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %14, i32 %15) #2, !srcloc !7
...
; <label>:45:                                     ; preds = %44, %43
  ...
  %48 = call { i32, i32 } asm "shllv_s.w $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %46, i32 %47) #2, !srcloc !8
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 226, i32 249, i32 273}
!8 = !{i32 554, i32 577, i32 601}
