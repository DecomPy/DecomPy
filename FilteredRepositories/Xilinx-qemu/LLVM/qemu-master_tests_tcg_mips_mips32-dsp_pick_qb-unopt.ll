...
define i32 @main() #0 {
  ...
  store i32 251658240, i32* %5, align 4, !tbaa !3
  ...
  %15 = call i32 asm "wrdsp $3, 0x10\0A\09pick.qb $0, $1, $2\0A\09", "=r,r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %12, i32 %13, i32 %14) #2, !srcloc !7
...
; <label>:27:                                     ; preds = %26, %25
  ...
  %31 = call i32 asm "wrdsp $3, 0x10\0A\09pick.qb $0, $1, $2\0A\09", "=r,r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %28, i32 %29, i32 %30) #2, !srcloc !8
