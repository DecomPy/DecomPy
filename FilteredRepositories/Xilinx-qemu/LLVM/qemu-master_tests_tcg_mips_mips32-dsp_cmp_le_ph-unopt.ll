...
define i32 @main() #0 {
  ...
  %12 = call i32 asm "cmp.le.ph $1, $2\0A\09rddsp $0\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %10, i32 %11) #2, !srcloc !7
...
; <label>:27:                                     ; preds = %26, %25
  ...
  %30 = call i32 asm "cmp.le.ph $1, $2\0A\09rddsp $0\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %28, i32 %29) #2, !srcloc !8
