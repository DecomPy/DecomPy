...
define i32 @main() #0 {
  ...
  store i32 33950223, i32* %4, align 4
  %5 = load i32, i32* %3, align 4
  %6 = call i32 asm "shra.qb $0, $1, 0x03\0A\09", "=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %5) #2, !srcloc !3
...
; <label>:17:                                     ; preds = %16, %15
  ...
  store i32 -267646972, i32* %4, align 4
  %18 = load i32, i32* %3, align 4
  %19 = call i32 asm "shra.qb $0, $1, 0x03\0A\09", "=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %18) #2, !srcloc !4
