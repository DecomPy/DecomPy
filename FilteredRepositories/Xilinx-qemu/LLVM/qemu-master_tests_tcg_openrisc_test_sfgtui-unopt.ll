...
define i32 @main() #0 {
  ...
  %10 = call i32 asm "1:\0A\09l.addi   $0, $0, 1\0A\09l.sfgtui $0, 0x3\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 %9) #4, !srcloc !7
...
; <label>:16:                                     ; preds = %0
  ...
  %19 = call i32 asm "1:\0A\09l.sub     $0, $0, $1\0A\09l.sfgtui  $0, 0x3\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %18, i32 %17) #4, !srcloc !8
...
!8 = !{i32 377, i32 382, i32 414, i32 443, i32 462, i32 479}
