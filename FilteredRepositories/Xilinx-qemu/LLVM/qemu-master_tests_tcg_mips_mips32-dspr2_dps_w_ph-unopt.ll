...
define i32 @main() #0 {
  ...
  store i32 -760, i32* %7, align 4, !tbaa !3
  ...
  %18 = call { i32, i32 } asm "mthi  $0, $$ac1\0A\09mtlo  $1, $$ac1\0A\09dps.w.ph $$ac1, $2, $3\0A\09mfhi  $0, $$ac1\0A\09mflo  $1, $$ac1\0A\09", "=r,=r,r,r,0,1,~{dirflag},~{fpsr},~{flags}"(i32 %16, i32 %17, i32 %14, i32 %15) #2, !srcloc !7
...
; <label>:44:                                     ; preds = %43, %42
  ...
  store i32 -504, i32* %7, align 4, !tbaa !3
  ...
  %49 = call { i32, i32 } asm "mthi  $0, $$ac1\0A\09mtlo  $1, $$ac1\0A\09dps.w.ph $$ac1, $2, $3\0A\09mfhi  $0, $$ac1\0A\09mflo  $1, $$ac1\0A\09", "=r,=r,r,r,0,1,~{dirflag},~{fpsr},~{flags}"(i32 %47, i32 %48, i32 %45, i32 %46) #2, !srcloc !8
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 237, i32 254, i32 284, i32 321, i32 351, i32 381}
!8 = !{i32 650, i32 667, i32 697, i32 734, i32 764, i32 794}
