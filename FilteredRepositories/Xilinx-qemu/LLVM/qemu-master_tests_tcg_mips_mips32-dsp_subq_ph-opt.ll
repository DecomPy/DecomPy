...
define i32 @main() #0 {
  ...
  store i32 2004318071, i32* %3, align 4
  store i32 1734689569, i32* %4, align 4
  store i32 269628502, i32* %6, align 4
  store i32 0, i32* %7, align 4
  %8 = load i32, i32* %3, align 4
  %9 = load i32, i32* %4, align 4
  %10 = call { i32, i32 } asm "subq.ph $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %8, i32 %9) #2, !srcloc !3
...
; <label>:37:                                     ; preds = %36, %35
  ...
  store i32 -1966140585, i32* %6, align 4
  store i32 1, i32* %7, align 4
  %38 = load i32, i32* %3, align 4
  %39 = load i32, i32* %4, align 4
  %40 = call { i32, i32 } asm "subq.ph $0, $2, $3\0A\09rddsp $1\0A\09", "=r,=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %38, i32 %39) #2, !srcloc !4
...
!3 = !{i32 217, i32 238, i32 262}
!4 = !{i32 536, i32 557, i32 581}
