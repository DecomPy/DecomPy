...
define i32 @main() #0 {
  ...
  %7 = call i32 asm "prepend $0, $1, 0x00\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %6, i32 %5) #2, !srcloc !3
...
; <label>:18:                                     ; preds = %17, %16
  store i32 305419896, i32* %2, align 4
  store i32 -2023406815, i32* %3, align 4
  store i32 -1393488182, i32* %4, align 4
  %19 = load i32, i32* %3, align 4
  %20 = load i32, i32* %2, align 4
  %21 = call i32 asm "prepend $0, $1, 0x0F\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %20, i32 %19) #2, !srcloc !4
