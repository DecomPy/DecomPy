...
define i32 @main() #0 {
  ...
  %13 = call { i32, i32 } asm "wrdsp $$0\0A\09shll.qb $0, $2, 0x00\0A\09rddsp   $1\0A\09", "=r,=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %12) #2, !srcloc !7
...
; <label>:42:                                     ; preds = %41, %40
  store i32 -2023406815, i32* %3, align 4, !tbaa !3
  store i32 942151688, i32* %5, align 4, !tbaa !3
  store i32 1, i32* %6, align 4, !tbaa !3
  %43 = load i32, i32* %3, align 4, !tbaa !3
  %44 = call { i32, i32 } asm "wrdsp $$0\0A\09shll.qb $0, $2, 0x03\0A\09rddsp   $1\0A\09", "=r,=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %43) #2, !srcloc !8
...
; <label>:73:                                     ; preds = %72, %71
  ...
  %75 = call { i32, i32 } asm "wrdsp $$0\0A\09shll.qb $0, $2, 0x07\0A\09rddsp   $1\0A\09", "=r,=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %74) #2, !srcloc !9
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 195, i32 206, i32 242, i32 268}
!8 = !{i32 512, i32 523, i32 559, i32 585}
!9 = !{i32 829, i32 840, i32 876, i32 902}
