; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_extrv_w.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_extrv_w.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@__func__.main = private unnamed_addr constant [5 x i8] c"main\00", align 1
@.str = private unnamed_addr constant [84 x i8] c"Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_extrv_w.c\00", align 1
...
define i32 @main() #0 {
  ...
  %18 = call { i32, i32 } asm "wrdsp $1, 0x01\0A\09mthi $3, $$ac1\0A\09mtlo $4, $$ac1\0A\09extrv.w $0, $$ac1, $2\0A\09rddsp $1\0A\09", "=r,=r,r,r,r,1,~{dirflag},~{fpsr},~{flags}"(i32 %15, i32 %16, i32 %17, i32 %14) #2, !srcloc !7
...
; <label>:31:                                     ; preds = %0
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str, i32 0, i32 0), i32 25, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %34
...
; <label>:43:                                     ; preds = %34
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str, i32 0, i32 0), i32 26, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %46
...
; <label>:46:                                     ; preds = %45, %44
  ...
  store i32 46283, i32* %5, align 4, !tbaa !3
  store i32 268438348, i32* %7, align 4, !tbaa !3
  ...
  %52 = call { i32, i32 } asm "wrdsp $1, 0x01\0A\09mthi $3, $$ac1\0A\09mtlo $4, $$ac1\0A\09extrv.w $0, $$ac1, $2\0A\09rddsp $1\0A\09", "=r,=r,r,r,r,1,~{dirflag},~{fpsr},~{flags}"(i32 %49, i32 %50, i32 %51, i32 %48) #2, !srcloc !9
...
; <label>:65:                                     ; preds = %46
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str, i32 0, i32 0), i32 50, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %68
...
; <label>:77:                                     ; preds = %68
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str, i32 0, i32 0), i32 51, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %80
...
; <label>:80:                                     ; preds = %79, %78
  ...
  %86 = call { i32, i32 } asm "wrdsp $1, 0x01\0A\09mthi $3, $$ac1\0A\09mtlo $4, $$ac1\0A\09extrv.w $0, $$ac1, $2\0A\09rddsp $1\0A\09", "=r,=r,r,r,r,1,~{dirflag},~{fpsr},~{flags}"(i32 %83, i32 %84, i32 %85, i32 %82) #2, !srcloc !11
...
; <label>:99:                                     ; preds = %80
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str, i32 0, i32 0), i32 75, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %102
...
; <label>:111:                                    ; preds = %102
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str, i32 0, i32 0), i32 76, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0)) #5
  unreachable
                                                  ; No predecessors!
  br label %114
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 212, i32 229, i32 258, i32 287, i32 323, i32 347}
!8 = !{i32 570, i32 581}
!9 = !{i32 718, i32 735, i32 764, i32 793, i32 829, i32 853}
!10 = !{i32 1076, i32 1087}
!11 = !{i32 1235, i32 1252, i32 1281, i32 1310, i32 1346, i32 1370}
