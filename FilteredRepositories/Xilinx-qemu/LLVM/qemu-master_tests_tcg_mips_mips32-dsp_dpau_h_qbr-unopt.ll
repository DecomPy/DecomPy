; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_dpau_h_qbr.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_dpau_h_qbr.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@__func__.main = private unnamed_addr constant [5 x i8] c"main\00", align 1
@.str = private unnamed_addr constant [87 x i8] c"Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dsp_dpau_h_qbr.c\00", align 1
...
define i32 @main() #0 {
  ...
  store i32 -2147483646, i32* %3, align 4, !tbaa !3
  store i32 5, i32* %6, align 4, !tbaa !3
  store i32 513, i32* %7, align 4, !tbaa !3
  ...
  %18 = call { i32, i32 } asm "mthi       $0, $$ac1\0A\09mtlo       $1, $$ac1\0A\09dpau.h.qbr $$ac1, $2, $3\0A\09mfhi       $0,   $$ac1\0A\09mflo       $1,   $$ac1\0A\09", "=r,=r,r,r,0,1,~{dirflag},~{fpsr},~{flags}"(i32 %16, i32 %17, i32 %14, i32 %15) #2, !srcloc !7
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{i32 243, i32 265, i32 300, i32 339, i32 376, i32 413}
