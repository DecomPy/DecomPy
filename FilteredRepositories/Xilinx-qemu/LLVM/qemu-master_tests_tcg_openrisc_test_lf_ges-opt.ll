...
define i32 @main() #0 {
  ...
  %9 = call i32 asm "lfges:\0A\09l.addi    $0, $0, 0x1\0A\09lf.sfge.s $1, $2\0A\09l.bf      lfges\0A\09l.nop\0A\09", "=r,r,r,0,~{dirflag},~{fpsr},~{flags}"(float %7, float %8, i32 %6) #2, !srcloc !3
...
; <label>:15:                                     ; preds = %0
  ...
  %19 = call i32 asm "l.addi    $0, $0, 0x1\0A\09l.addi    $0, $0, 0x1\0A\09lf.sfge.s $1, $2\0A\09l.bf      1f\0A\09l.nop\0A\09l.addi    $0, $0, 0x1\0A\09l.addi    $0, $0, 0x1\0A\091:\0A\09", "=r,r,r,0,~{dirflag},~{fpsr},~{flags}"(float %17, float %18, i32 %16) #2, !srcloc !4
...
!4 = !{i32 459, i32 483, i32 516, i32 544, i32 568, i32 585, i32 618, i32 651, i32 665}
