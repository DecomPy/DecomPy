...
define i32 @main() #0 {
  ...
  store i32 167772160, i32* %5, align 4
  store i32 305414945, i32* %6, align 4
  %7 = load i32, i32* %3, align 4
  %8 = load i32, i32* %4, align 4
  %9 = load i32, i32* %5, align 4
  %10 = call i32 asm "wrdsp $3, 0x10\0A\09pick.ph $0, $1, $2\0A\09", "=r,r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %7, i32 %8, i32 %9) #2, !srcloc !3
...
; <label>:21:                                     ; preds = %20, %19
  store i32 305419896, i32* %3, align 4
  store i32 -2023406815, i32* %4, align 4
  store i32 50331648, i32* %5, align 4
  store i32 305419896, i32* %6, align 4
  %22 = load i32, i32* %3, align 4
  %23 = load i32, i32* %4, align 4
  %24 = load i32, i32* %5, align 4
  %25 = call i32 asm "wrdsp $3, 0x10\0A\09pick.ph $0, $1, $2\0A\09", "=r,r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %22, i32 %23, i32 %24) #2, !srcloc !4
...
; <label>:36:                                     ; preds = %35, %34
  ...
  %40 = call i32 asm "wrdsp $3, 0x10\0A\09pick.ph $0, $1, $2\0A\09", "=r,r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %37, i32 %38, i32 %39) #2, !srcloc !5
...
; <label>:48:                                     ; preds = %36
  call void @__assert_rtn(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__func__.main, i32 0, i32 0), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str, i32 0, i32 0), i32 46, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0)) #3
  unreachable
                                                  ; No predecessors!
  br label %51
