...
define i32 @main() #0 {
  ...
  %8 = call i32 asm "cmpu.lt.qb $1, $2\0A\09rddsp $0\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %6, i32 %7) #2, !srcloc !3
...
; <label>:22:                                     ; preds = %21, %20
  ...
  %25 = call i32 asm "cmpu.lt.qb $1, $2\0A\09rddsp $0\0A\09", "=r,r,r,~{dirflag},~{fpsr},~{flags}"(i32 %23, i32 %24) #2, !srcloc !4
