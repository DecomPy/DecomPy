...
define i32 @main() #0 {
  ...
  %8 = call i32 asm "1:\0A\09l.addi   $0, $0, 1\0A\09l.sfgeu  $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %7, i32 %6) #2, !srcloc !3
...
; <label>:14:                                     ; preds = %0
  ...
  %18 = call i32 asm "1:\0A\09l.sub    $0, $0, $2\0A\09l.sfgeu  $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %16, i32 %17, i32 %15) #2, !srcloc !4
...
!4 = !{i32 413, i32 418, i32 449, i32 476, i32 495, i32 512}
