...
define i32 @main() #0 {
  ...
  %14 = call i32 asm "lfgts:\0A\09l.addi    $0, $0, 0x1\0A\09lf.sfgt.s $1, $2\0A\09l.bf      lfgts\0A\09l.nop\0A\09", "=r,r,r,0,~{dirflag},~{fpsr},~{flags}"(float %12, float %13, i32 %11) #4, !srcloc !9
...
; <label>:20:                                     ; preds = %0
  ...
  %24 = call i32 asm "lf.sfgt.s $1, $2\0A\09l.bf      1f\0A\09l.nop\0A\09l.addi    $0, $0, 0x1\0A\09l.addi    $0, $0, 0x1\0A\091:\0A\09", "=r,r,r,0,~{dirflag},~{fpsr},~{flags}"(float %22, float %23, i32 %21) #4, !srcloc !10
...
!10 = !{i32 459, i32 478, i32 502, i32 519, i32 552, i32 585, i32 599}
