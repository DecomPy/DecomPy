...
define i32 @main() #0 {
  ...
  %6 = call i32 asm "1:\0A\09l.addi   $0, $0, 1\0A\09l.sfgesi $0, 0x3\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 %5) #2, !srcloc !3
...
; <label>:12:                                     ; preds = %0
  ...
  %15 = call i32 asm "1:\0A\09l.sub    $0, $0, $1\0A\09l.sfgesi $0, 0x3\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %14, i32 %13) #2, !srcloc !4
...
!3 = !{i32 111, i32 116, i32 146, i32 174, i32 193, i32 210}
!4 = !{i32 375, i32 380, i32 411, i32 439, i32 458, i32 475}
