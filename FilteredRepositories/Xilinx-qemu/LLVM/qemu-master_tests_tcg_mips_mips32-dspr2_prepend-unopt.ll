; ModuleID = 'Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_prepend.c'
source_filename = "Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_prepend.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@__func__.main = private unnamed_addr constant [5 x i8] c"main\00", align 1
@.str = private unnamed_addr constant [86 x i8] c"Repositories/Xilinx-qemu/Unfiltered/qemu-master_tests_tcg_mips_mips32-dspr2_prepend.c\00", align 1
...
define i32 @main() #0 {
  ...
  %10 = call i32 asm "prepend $0, $1, 0x00\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %9, i32 %8) #2, !srcloc !7
...
; <label>:22:                                     ; preds = %21, %20
  store i32 305419896, i32* %2, align 4, !tbaa !3
  store i32 -2023406815, i32* %3, align 4, !tbaa !3
  store i32 -1393488182, i32* %4, align 4, !tbaa !3
  %23 = load i32, i32* %3, align 4, !tbaa !3
  %24 = load i32, i32* %2, align 4, !tbaa !3
  %25 = call i32 asm "prepend $0, $1, 0x0F\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %24, i32 %23) #2, !srcloc !8
