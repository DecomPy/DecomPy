...
define i32 @main() #0 {
  ...
  %13 = call i32 asm "1:\0A\09l.addi   $0, $0, 1\0A\09l.sfgts  $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %12, i32 %11) #4, !srcloc !7
...
; <label>:19:                                     ; preds = %0
  ...
  %23 = call i32 asm "1:\0A\09l.sub    $0, $0, $2\0A\09l.sfgts  $0, $1\0A\09l.bf 1b\0A\09l.nop\0A\09", "=r,r,r,0,~{dirflag},~{fpsr},~{flags}"(i32 %21, i32 %22, i32 %20) #4, !srcloc !8
...
!8 = !{i32 414, i32 419, i32 450, i32 477, i32 496, i32 513}
