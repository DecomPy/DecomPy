...
define i32 @main(i32) #0 {
  ...
  store i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i8** @M, align 8
  %4 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %3)
  %5 = trunc i32 %4 to i8
  store i8 %5, i8* @A, align 1
  store i8 %5, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @J, i32 0, i32 0), align 16
  br label %6

; <label>:6:                                      ; preds = %12, %1
  %7 = load i8, i8* @E, align 1
  %8 = add i8 %7, -1
  store i8 %8, i8* @E, align 1
  %9 = icmp ne i8 %8, 0
...
; <label>:121:                                    ; preds = %112
  %122 = load i8, i8* @Z, align 1
  %123 = sext i8 %122 to i32
  %124 = icmp ne i32 %123, 0
  br i1 %124, label %129, label %125

; <label>:125:                                    ; preds = %121
  %126 = load i8*, i8** @M, align 8
