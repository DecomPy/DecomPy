; ModuleID = 'Repositories/LeechanX-Data-Structures-and-Algorithms-in-C/Unfiltered/Data-Structures-and-Algorithms-in-C-master_Sort_SortApplication_quicksort_k_small.c'
source_filename = "Repositories/LeechanX-Data-Structures-and-Algorithms-in-C/Unfiltered/Data-Structures-and-Algorithms-in-C-master_Sort_SortApplication_quicksort_k_small.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@.str = private unnamed_addr constant [4 x i8] c"%d \00", align 1
@.str.1 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str.2 = private unnamed_addr constant [23 x i8] c"%dth minest number=%d\0A\00", align 1
...
@.str.3 = private unnamed_addr constant [23 x i8] c"top%d minest numbers:\0A\00", align 1
...
; <label>:87:                                     ; preds = %79
  ...
  call void @quicksplit_findtopk(i32* %88, i32 %89, i32 %90, i32 %91)
  br label %120

; <label>:92:                                     ; preds = %79
  %93 = load i32, i32* %10, align 4, !tbaa !7
...
; <label>:96:                                     ; preds = %92
  ...
  %98 = load i32, i32* %10, align 4, !tbaa !7
  %99 = add nsw i32 %98, 1
  %100 = load i32, i32* %7, align 4, !tbaa !7
  %101 = load i32, i32* %8, align 4, !tbaa !7
  call void @quicksplit_findtopk(i32* %97, i32 %99, i32 %100, i32 %101)
  br label %119
...
; <label>:104:                                    ; preds = %108, %102
  %105 = load i32, i32* %12, align 4, !tbaa !7
...
; <label>:108:                                    ; preds = %104
  ...
  store i32 %111, i32* %12, align 4, !tbaa !7
...
; Function Attrs: nounwind ssp uwtable
define void @quicksplit_find_kth_min(i32*, i32, i32, i32) #0 {
  %5 = alloca i32*, align 8
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  %8 = alloca i32, align 4
...
; <label>:87:                                     ; preds = %78
  ...
  %90 = load i32, i32* %10, align 4, !tbaa !7
  %91 = load i32, i32* %8, align 4, !tbaa !7
  call void @quicksplit_find_kth_min(i32* %88, i32 %89, i32 %90, i32 %91)
  br label %108
...
; <label>:97:                                     ; preds = %92
  ...
  call void @quicksplit_find_kth_min(i32* %98, i32 %100, i32 %101, i32 %102)
  br label %107
...
define i32 @main(i32, i8**) #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 200, i8* %9) #3
  %10 = bitcast [50 x i32]* %6 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %10, i8* align 16 bitcast ([50 x i32]* @main.data to i8*), i64 200, i1 false)
  ...
  store i32 %16, i32* %8, align 4, !tbaa !7
...
; <label>:22:                                     ; preds = %20, %2
  %23 = getelementptr inbounds [50 x i32], [50 x i32]* %6, i32 0, i32 0
  %24 = load i32, i32* %7, align 4, !tbaa !7
  %25 = load i32, i32* %8, align 4, !tbaa !7
  call void @quicksplit_find_kth_min(i32* %23, i32 0, i32 %24, i32 %25)
...
; <label>:32:                                     ; preds = %29, %22
  ...
  %34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i32 0, i32 0), i32 %33)
  %35 = getelementptr inbounds [50 x i32], [50 x i32]* %6, i32 0, i32 0
  %36 = load i32, i32* %7, align 4, !tbaa !7
  %37 = load i32, i32* %8, align 4, !tbaa !7
  call void @quicksplit_findtopk(i32* %35, i32 0, i32 %36, i32 %37)
  ...
  call void @llvm.lifetime.end.p0i8(i64 200, i8* %40) #3
  ret i32 0
}
