...
; <label>:17:                                     ; preds = %4
  ...
  %19 = load i32, i32* @print_answer.count, align 4
  %20 = add nsw i32 %19, 1
  store i32 %20, i32* @print_answer.count, align 4
  ret void
}
...
; <label>:24:                                     ; preds = %18
  %25 = getelementptr inbounds [5 x i32], [5 x i32]* %5, i32 0, i32 0
  ...
  %32 = call i32 @condition(i32* %25, i32 %30, i32 %31)
  %33 = icmp ne i32 %32, 0
  %34 = xor i1 %33, true
  br label %35
...
; <label>:55:                                     ; preds = %52
  ...
  %64 = getelementptr inbounds [5 x i32], [5 x i32]* %5, i32 0, i32 0
  call void @print_answer(i32* %64)
  br label %79
