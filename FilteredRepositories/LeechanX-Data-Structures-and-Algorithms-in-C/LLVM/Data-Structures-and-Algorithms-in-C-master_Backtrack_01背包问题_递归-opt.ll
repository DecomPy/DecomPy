...
; <label>:20:                                     ; preds = %17
  ...
  %24 = load i32, i32* %9, align 4
  %25 = call i32 @condition(i32* %21, i32* %22, i32 %23, i32 %24)
  %26 = icmp ne i32 %25, 0
...
; <label>:27:                                     ; preds = %20
  ...
  %37 = add nsw i32 %36, 1
  call void @backtrack(i32* %33, i32* %34, i32* %35, i32 %37)
  br label %38
...
define i32 @main(i32, i8**) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %10, i8* align 16 bitcast ([5 x i32]* @main.value to i8*), i64 20, i1 false)
  %11 = getelementptr inbounds [5 x i32], [5 x i32]* %6, i32 0, i32 0
  %12 = getelementptr inbounds [5 x i32], [5 x i32]* %7, i32 0, i32 0
  %13 = getelementptr inbounds [5 x i32], [5 x i32]* %8, i32 0, i32 0
  call void @backtrack(i32* %11, i32* %12, i32* %13, i32 0)
  %14 = load i32, i32* @maxvalue, align 4
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i32 0, i32 0), i32 %14)
  %16 = load i32, i32* @weighted, align 4
