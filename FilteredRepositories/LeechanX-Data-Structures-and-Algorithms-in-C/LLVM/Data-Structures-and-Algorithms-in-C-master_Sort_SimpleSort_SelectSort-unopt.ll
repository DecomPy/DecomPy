; ModuleID = 'Repositories/LeechanX-Data-Structures-and-Algorithms-in-C/Unfiltered/Data-Structures-and-Algorithms-in-C-master_Sort_SimpleSort_SelectSort.c'
source_filename = "Repositories/LeechanX-Data-Structures-and-Algorithms-in-C/Unfiltered/Data-Structures-and-Algorithms-in-C-master_Sort_SimpleSort_SelectSort.c"
...
; Function Attrs: nounwind ssp uwtable
define void @selectsort(i32*, i32) #0 {
...
; <label>:47:                                     ; preds = %46
  ...
  %49 = add nsw i32 %48, 1
  store i32 %49, i32* %8, align 4, !tbaa !7
  br label %27
...
; <label>:54:                                     ; preds = %50
  ...
  call void @swap(i32* %55, i32 %56, i32 %57)
  br label %58
...
; <label>:59:                                     ; preds = %58
  ...
  %61 = add nsw i32 %60, 1
  store i32 %61, i32* %7, align 4, !tbaa !7
  br label %13
...
define i32 @main() #0 {
  ...
  call void @selectsort(i32* %7, i32 %8)
