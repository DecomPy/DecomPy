; ModuleID = 'Repositories/obonaventure-SystemesInformatiques/Unfiltered/SystemesInformatiques-master_Exercices_Programmes_src_sumarray.c'
source_filename = "Repositories/obonaventure-SystemesInformatiques/Unfiltered/SystemesInformatiques-master_Exercices_Programmes_src_sumarray.c"
...
; <label>:11:                                     ; preds = %8
  ...
  %14 = getelementptr inbounds [10000 x [10000 x i32]], [10000 x [10000 x i32]]* @matrix, i64 0, i64 %13
...
; <label>:15:                                     ; preds = %12
  ...
  %18 = getelementptr inbounds [10000 x [10000 x i32]], [10000 x [10000 x i32]]* @matrix, i64 0, i64 %17
...
; <label>:29:                                     ; preds = %8
  ...
  %32 = call i32 @sum2()
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32 %32)
  ret i32 0
}
