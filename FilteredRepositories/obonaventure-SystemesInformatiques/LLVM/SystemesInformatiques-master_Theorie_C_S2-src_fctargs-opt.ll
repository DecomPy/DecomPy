...
define void @wrong() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %2, i8* align 16 bitcast ([5 x i32]* @wrong.vecteur to i8*), i64 20, i1 false)
  %3 = getelementptr inbounds [5 x i32], [5 x i32]* %1, i32 0, i32 0
  %4 = ptrtoint i32* %3 to i32
  call void @plusun(i32 %4, i32* inttoptr (i64 5 to i32*))
  %5 = getelementptr inbounds [5 x i32], [5 x i32]* %1, i32 0, i32 0
  call void @print_vecteur(i32 5, i32* %5)
  ret void
}
...
define i32 @main(i32, i8**) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %7, i8* align 16 bitcast ([5 x i32]* @main.vecteur to i8*), i64 20, i1 false)
  %8 = getelementptr inbounds [5 x i32], [5 x i32]* %6, i32 0, i32 0
  call void @plusun(i32 5, i32* %8)
  %9 = getelementptr inbounds [5 x i32], [5 x i32]* %6, i32 0, i32 0
  call void @print_vecteur(i32 5, i32* %9)
  ret i32 0
}
