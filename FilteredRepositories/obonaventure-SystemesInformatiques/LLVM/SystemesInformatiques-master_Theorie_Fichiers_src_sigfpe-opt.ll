...
define i32 @main(i32, i8**) #0 {
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i32 %8, i32 %9)
  %11 = load %struct.__sFILE*, %struct.__sFILE** @__stdoutp, align 8
  %12 = call i32 @fflush(%struct.__sFILE* %11)
  %13 = load i32, i32* %6, align 4
  %14 = load i32, i32* %7, align 4
  %15 = sdiv i32 %13, %14
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 %15)
  ret i32 0
}
