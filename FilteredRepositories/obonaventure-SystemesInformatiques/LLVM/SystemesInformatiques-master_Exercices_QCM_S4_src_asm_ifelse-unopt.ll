; ModuleID = 'Repositories/obonaventure-SystemesInformatiques/Unfiltered/SystemesInformatiques-master_Exercices_QCM_S4_src_asm_ifelse.c'
source_filename = "Repositories/obonaventure-SystemesInformatiques/Unfiltered/SystemesInformatiques-master_Exercices_QCM_S4_src_asm_ifelse.c"
...
; <label>:4:                                      ; preds = %0
  ...
  %6 = add nsw i32 %5, 1
  store i32 %6, i32* @a, align 4, !tbaa !3
  br label %10

; <label>:7:                                      ; preds = %0
  %8 = load i32, i32* @b, align 4, !tbaa !3
  %9 = add nsw i32 %8, 1
  store i32 %9, i32* @b, align 4, !tbaa !3
  br label %10
