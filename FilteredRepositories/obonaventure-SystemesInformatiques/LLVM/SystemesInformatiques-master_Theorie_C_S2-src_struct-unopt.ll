...
define i32 @equalptr(%struct.fraction*, %struct.fraction*) #0 {
  ...
  store %struct.fraction* %0, %struct.fraction** %3, align 8, !tbaa !10
  store %struct.fraction* %1, %struct.fraction** %4, align 8, !tbaa !10
  %5 = load %struct.fraction*, %struct.fraction** %3, align 8, !tbaa !10
  %6 = getelementptr inbounds %struct.fraction, %struct.fraction* %5, i32 0, i32 0
  %7 = load i32, i32* %6, align 4, !tbaa !7
  %8 = load %struct.fraction*, %struct.fraction** %4, align 8, !tbaa !10
...
; <label>:12:                                     ; preds = %2
  %13 = load %struct.fraction*, %struct.fraction** %3, align 8, !tbaa !10
  %14 = getelementptr inbounds %struct.fraction, %struct.fraction* %13, i32 0, i32 1
  %15 = load i32, i32* %14, align 4, !tbaa !9
  %16 = load %struct.fraction*, %struct.fraction** %4, align 8, !tbaa !10
...
define void @initptr(%struct.fraction*, i32, i32) #0 {
  ...
  store %struct.fraction* %0, %struct.fraction** %4, align 8, !tbaa !10
  store i32 %1, i32* %5, align 4, !tbaa !3
  ...
  %11 = load %struct.fraction*, %struct.fraction** %4, align 8, !tbaa !10
...
define i32 @main(i32, i8**) #0 {
  ...
  store i32 1, i32* getelementptr inbounds (%struct.coord, %struct.coord* @point, i32 0, i32 0), align 4, !tbaa !12
  store i32 2, i32* getelementptr inbounds (%struct.coord, %struct.coord* @point, i32 0, i32 1), align 4, !tbaa !14
  store i32 3, i32* getelementptr inbounds (%struct.coord, %struct.coord* @point, i32 0, i32 2), align 4, !tbaa !15
  %12 = bitcast %struct.fraction* %7 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %12) #3
  %13 = bitcast %struct.fraction* %8 to i8*
  ...
  %15 = call i64 @init(i32 1, i32 4)
  %16 = bitcast %struct.fraction* %9 to i64*
  store i64 %15, i64* %16, align 4
  %17 = bitcast %struct.fraction* %7 to i8*
  %18 = bitcast %struct.fraction* %9 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %17, i8* align 4 %18, i64 8, i1 false), !tbaa.struct !16
  %19 = bitcast %struct.fraction* %9 to i8*
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %19) #3
  call void @initptr(%struct.fraction* %8, i32 1, i32 3)
  %20 = bitcast %struct.fraction* %8 to i64*
  %21 = load i64, i64* %20, align 4
  %22 = bitcast %struct.fraction* %7 to i64*
  %23 = load i64, i64* %22, align 4
  %24 = call i32 @equal(i64 %21, i64 %23)
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i32 0, i32 0), i32 %24)
  %26 = call i32 @equalptr(%struct.fraction* %8, %struct.fraction* %7)
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i32 0, i32 0), i32 %26)
  store i32 1, i32* getelementptr inbounds (%struct.fraction, %struct.fraction* @f, i32 0, i32 0), align 4, !tbaa !7
  store i32 4, i32* getelementptr inbounds (%struct.fraction, %struct.fraction* @f, i32 0, i32 1), align 4, !tbaa !9
  %28 = load i8, i8* getelementptr inbounds (%struct.student, %struct.student* @s, i32 0, i32 1, i64 2), align 2, !tbaa !17
  %29 = sext i8 %28 to i32
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i32 %29)
  %31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.3, i32 0, i32 0), i64 12, i64 12)
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4, i32 0, i32 0), i64 56)
  %33 = bitcast %struct.fraction* %8 to i8*
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %33) #3
  %34 = bitcast %struct.fraction* %7 to i8*
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %34) #3
  %35 = bitcast [3 x i32]* %6 to i8*
  call void @llvm.lifetime.end.p0i8(i64 12, i8* %35) #3
  ret i32 0
}
...
!6 = !{!"Simple C/C++ TBAA"}
!7 = !{!8, !4, i64 0}
!8 = !{!"fraction", !4, i64 0, !4, i64 4}
!9 = !{!8, !4, i64 4}
!10 = !{!11, !11, i64 0}
!11 = !{!"any pointer", !5, i64 0}
!12 = !{!13, !4, i64 0}
!13 = !{!"coord", !4, i64 0, !4, i64 4, !4, i64 8}
!14 = !{!13, !4, i64 4}
!15 = !{!13, !4, i64 8}
!16 = !{i64 0, i64 4, !3, i64 4, i64 4, !3}
!17 = !{!5, !5, i64 0}
