...
define i32 @main(i32, i8**) #0 {
  ...
  store i8** %1, i8*** %5, align 8
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0), i8** %7, align 8
  %9 = load i8*, i8** %7, align 8
  %10 = call i32 @mystrtol(i8* %9, i8** %6, i32 10)
...
; <label>:14:                                     ; preds = %2
  ...
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0), i32 %17)
  br label %19

; <label>:19:                                     ; preds = %14, %2
  %20 = load i8*, i8** %7, align 8
  %21 = load i64, i64* %8, align 8
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i32 0, i32 0), i8* %20, i64 %21)
  ret i32 0
}
