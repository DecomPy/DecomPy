...
; <label>:36:                                     ; preds = %13
  %37 = call i32 @sum()
  %38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32 %37)
  %39 = call i32 @sum2()
  %40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), i32 %39)
  ret i32 0
}
