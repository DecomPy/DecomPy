; ModuleID = 'Repositories/vonzhou-CSAPP/Unfiltered/CSAPP-master_chapter02_inplace_swap.c'
source_filename = "Repositories/vonzhou-CSAPP/Unfiltered/CSAPP-master_chapter02_inplace_swap.c"
...
define i32 @main() #0 {
  ...
  store i32 99999, i32* %3, align 4, !tbaa !7
  %6 = load i32, i32* %2, align 4, !tbaa !7
  %7 = load i32, i32* %3, align 4, !tbaa !7
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i32 %6, i32 %7)
  call void @inplace_swap(i32* %2, i32* %3)
  %9 = load i32, i32* %2, align 4, !tbaa !7
  %10 = load i32, i32* %3, align 4, !tbaa !7
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i32 %9, i32 %10)
