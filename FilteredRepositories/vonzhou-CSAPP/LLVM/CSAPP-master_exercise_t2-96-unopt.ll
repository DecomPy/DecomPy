; ModuleID = 'Repositories/vonzhou-CSAPP/Unfiltered/CSAPP-master_exercise_t2-96.c'
source_filename = "Repositories/vonzhou-CSAPP/Unfiltered/CSAPP-master_exercise_t2-96.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

@.str = private unnamed_addr constant [38 x i8] c"0x%08X: [GOOD: 0x%08X] [BAD: 0x%08X]\0A\00", align 1
...
; <label>:10:                                     ; preds = %26, %0
  ...
  %12 = call i32 @float_f2i(i32 %11)
  store i32 %12, i32* %3, align 4, !tbaa !3
  %13 = load i32, i32* %5, align 4, !tbaa !3
  %14 = call float @u2f(i32 %13)
  store float %14, float* %2, align 4, !tbaa !7
  %15 = load float, float* %2, align 4, !tbaa !7
...
; <label>:20:                                     ; preds = %10
  ...
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str, i32 0, i32 0), i32 %21, i32 %22, i32 %23)
  br label %25
