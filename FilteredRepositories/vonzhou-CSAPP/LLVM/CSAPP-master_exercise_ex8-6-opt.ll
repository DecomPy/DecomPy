...
define i32 @main(i32, i8**) #0 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str, i32 0, i32 0))
...
; <label>:12:                                     ; preds = %8
  ...
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 %13, i8* %18)
  br label %20
...
; <label>:23:                                     ; preds = %8
  ...
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i32 0, i32 0))
  store i32 0, i32* %6, align 4
  br label %26
...
; <label>:33:                                     ; preds = %26
  ...
  %40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i32 0, i32 0), i32 %34, i8* %39)
  br label %41
