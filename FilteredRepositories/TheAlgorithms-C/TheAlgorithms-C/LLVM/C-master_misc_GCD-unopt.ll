; ModuleID = 'Repositories/TheAlgorithms-C/Unfiltered/C-master_misc_GCD.c'
source_filename = "Repositories/TheAlgorithms-C/Unfiltered/C-master_misc_GCD.c"
...
define i32 @main() #0 {
  ...
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0), i32* %1, i32* %2)
  %7 = load i32, i32* %1, align 4, !tbaa !3
  %8 = load i32, i32* %2, align 4, !tbaa !3
  %9 = call i32 @GCD(i32 %7, i32 %8)
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i32 0, i32 0), i32 %9)
