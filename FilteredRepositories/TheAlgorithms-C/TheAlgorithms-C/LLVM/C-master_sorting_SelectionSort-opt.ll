...
define i32 @main(i32, i8**) #0 {
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i32 0, i32 0))
  %11 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i32* %6)
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i32 0, i32 0))
...
; <label>:21:                                     ; preds = %17
  ...
  %25 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0), i32* %24)
  br label %26
...
; <label>:29:                                     ; preds = %17
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i32 0, i32 0))
  %31 = load i32, i32* %6, align 4
  call void @display(i32* %16, i32 %31)
  %32 = load i32, i32* %6, align 4
  call void @selectionSort(i32* %16, i32 %32)
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.6, i32 0, i32 0))
  %34 = load i32, i32* %6, align 4
  call void @display(i32* %16, i32 %34)
  store i32 0, i32* %3, align 4
