...
; <label>:15:                                     ; preds = %11
  ...
  %19 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32* %18)
  br label %20
...
; <label>:23:                                     ; preds = %11
  ...
  call void @shakersort(i32* %10, i32 %24)
  store i32 0, i32* %5, align 4
  br label %25
