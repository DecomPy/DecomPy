...
_http_404_html:
	...
	.globl	_http_referer           ## @http_referer
_http_referer:
	.asciz	"Referer:"

	.globl	_http_header_200        ## @http_header_200
	.p2align	4
_http_header_200:
	.asciz	"HTTP/1.0 200 OK\r\nServer: uIP/1.0 http://www.sics.se/~adam/uip/\r\nConnection: close\r\n"

	.globl	_http_header_404        ## @http_header_404
	.p2align	4
_http_header_404:
	.asciz	"HTTP/1.0 404 Not found\r\nServer: uIP/1.0 http://www.sics.se/~adam/uip/\r\nConnection: close\r\n"

	.globl	_http_content_type_plain ## @http_content_type_plain
	.p2align	4
