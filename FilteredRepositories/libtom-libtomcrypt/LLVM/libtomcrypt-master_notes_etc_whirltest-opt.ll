...
; <label>:4:                                      ; preds = %33, %0
  ...
  %7 = call i8* @fgets(i8* %5, i32 4094, %struct.__sFILE* %6)
  %8 = icmp ne i8* %7, null
...
; <label>:13:                                     ; preds = %10
  ...
  %22 = getelementptr inbounds [4096 x i8], [4096 x i8]* %2, i64 0, i64 %21
  %23 = load i8, i8* %22, align 1
  %24 = sext i8 %23 to i32
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i32 %18, i32 %24)
