...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %4, i8* align 16 getelementptr inbounds ([22 x i8], [22 x i8]* @main.str, i32 0, i32 0), i64 22, i1 false)
  %5 = bitcast [1 x i8]* %2 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 1 %5, i8 0, i64 1, i1 false)
  %6 = getelementptr inbounds [22 x i8], [22 x i8]* %1, i32 0, i32 0
  %7 = getelementptr inbounds [1 x i8], [1 x i8]* %2, i32 0, i32 0
  %8 = call i8* @ft_strstr(i8* %6, i8* %7)
  store i8* %8, i8** %3, align 8
  %9 = load i8*, i8** %3, align 8
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), i8* %9)
  ret i32 0
}
