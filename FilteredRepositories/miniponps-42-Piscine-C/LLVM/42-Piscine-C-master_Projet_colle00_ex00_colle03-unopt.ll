; ModuleID = 'Repositories/miniponps-42-Piscine-C/Unfiltered/42-Piscine-C-master_Projet_colle00_ex00_colle03.c'
source_filename = "Repositories/miniponps-42-Piscine-C/Unfiltered/42-Piscine-C-master_Projet_colle00_ex00_colle03.c"
...
; <label>:25:                                     ; preds = %21, %18
  ...
  call void @firstlastline(i32 %26, i32 %27)
  br label %31

; <label>:28:                                     ; preds = %21
  %29 = load i32, i32* %5, align 4, !tbaa !3
  %30 = load i32, i32* %3, align 4, !tbaa !3
  call void @midline(i32 %29, i32 %30)
  br label %31
