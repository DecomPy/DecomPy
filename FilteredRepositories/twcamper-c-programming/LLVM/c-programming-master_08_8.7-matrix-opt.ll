...
; <label>:10:                                     ; preds = %7
  ...
  %12 = add nsw i32 %11, 1
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i32 0, i32 0), i32 %12)
...
; <label>:32:                                     ; preds = %7
  ...
  %34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i32 0, i32 0))
  store i32 0, i32* %3, align 4
  br label %35
...
; <label>:55:                                     ; preds = %39
  ...
  %57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), i32 %56)
  br label %58
...
; <label>:61:                                     ; preds = %35
  ...
  %63 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.5, i32 0, i32 0))
  store i32 0, i32* %4, align 4
  br label %64
...
; <label>:84:                                     ; preds = %68
  ...
  %86 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), i32 %85)
  br label %87
