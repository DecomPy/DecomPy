...
define i8* @get_ones(i8 signext) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %4, i8* align 16 bitcast ([9 x i8*]* @get_ones.ones to i8*), i64 72, i1 false)
  %5 = load i8, i8* %2, align 1
  %6 = call i32 @toi(i8 signext %5)
  %7 = sub nsw i32 %6, 1
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [9 x i8*], [9 x i8*]* %3, i64 0, i64 %8
...
define i8* @get_tens(i8 signext) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %4, i8* align 16 bitcast ([8 x i8*]* @get_tens.tens to i8*), i64 64, i1 false)
  %5 = load i8, i8* %2, align 1
  %6 = call i32 @toi(i8 signext %5)
  %7 = sub nsw i32 %6, 2
  %8 = sext i32 %7 to i64
...
define i8* @get_teens(i8 signext) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %4, i8* align 16 bitcast ([10 x i8*]* @get_teens.teens to i8*), i64 80, i1 false)
  %5 = load i8, i8* %2, align 1
  %6 = call i32 @toi(i8 signext %5)
  %7 = sext i32 %6 to i64
