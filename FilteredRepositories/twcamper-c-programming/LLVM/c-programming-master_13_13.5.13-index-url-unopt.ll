...
define void @build_index_url(i8*, i8*) #0 {
  ...
  %6 = load i8*, i8** %4, align 8, !tbaa !3
  %7 = call i64 @llvm.objectsize.i64.p0i8(i8* %6, i1 false, i1 true)
  %8 = call i8* @__strcpy_chk(i8* %5, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), i64 %7) #5
  ...
  %13 = call i8* @__strcat_chk(i8* %9, i8* %10, i64 %12) #5
  %14 = load i8*, i8** %4, align 8, !tbaa !3
  %15 = load i8*, i8** %4, align 8, !tbaa !3
  %16 = call i64 @llvm.objectsize.i64.p0i8(i8* %15, i1 false, i1 true)
  %17 = call i8* @__strcat_chk(i8* %14, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i64 %16) #5
  ret void
}
...
; <label>:9:                                      ; preds = %2
  %10 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8, !tbaa !3
...
; <label>:15:                                     ; preds = %2
  %16 = bitcast [255 x i8]* %6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 255, i8* %16) #5
  ...
  call void @build_index_url(i8* %19, i8* %20)
  %21 = getelementptr inbounds [255 x i8], [255 x i8]* %6, i32 0, i32 0
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), i8* %21)
  store i32 0, i32* %3, align 4
  %23 = bitcast [255 x i8]* %6 to i8*
  call void @llvm.lifetime.end.p0i8(i64 255, i8* %23) #5
  br label %24
