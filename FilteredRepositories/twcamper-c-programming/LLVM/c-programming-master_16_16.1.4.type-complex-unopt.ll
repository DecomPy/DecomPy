...
define { double, double } @make_complex(double, double) #0 {
  ...
  %7 = load double, double* %4, align 8, !tbaa !3
  store double %7, double* %6, align 8, !tbaa !7
  %8 = getelementptr inbounds %struct.complex, %struct.complex* %3, i32 0, i32 1
  %9 = load double, double* %5, align 8, !tbaa !3
...
define { double, double } @add_complex(double, double, double, double) #0 {
  ...
  store double %19, double* %14, align 8, !tbaa !7
  ...
  store double %25, double* %20, align 8, !tbaa !9
