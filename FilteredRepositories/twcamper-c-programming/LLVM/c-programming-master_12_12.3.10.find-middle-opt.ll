...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %4, i8* align 16 bitcast ([9 x i32]* @main.ar to i8*), i64 36, i1 false)
  %5 = getelementptr inbounds [9 x i32], [9 x i32]* %2, i32 0, i32 0
  %6 = getelementptr inbounds i32, i32* %5, i64 3
  %7 = call i32* @find_middle(i32* %6, i32 9)
  store i32* %7, i32** %3, align 8
  %8 = load i32*, i32** %3, align 8
  %9 = load i32*, i32** %3, align 8
  %10 = load i32, i32* %9, align 4
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i32 0, i32 0), i32* %8, i32 %10)
  ret i32 0
}
