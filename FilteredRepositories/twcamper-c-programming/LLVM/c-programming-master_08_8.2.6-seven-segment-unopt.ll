...
define i32 @main() #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 280, i8* %3) #2
  %4 = bitcast [10 x [7 x i32]]* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %4, i8* align 16 bitcast ([10 x [7 x i32]]* @main.segments to i8*), i64 280, i1 false)
  %5 = bitcast [10 x [7 x i32]]* %2 to i8*
  call void @llvm.lifetime.end.p0i8(i64 280, i8* %5) #2
  ret i32 0
}
