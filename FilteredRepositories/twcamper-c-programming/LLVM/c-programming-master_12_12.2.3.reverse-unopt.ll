...
define i32 @main() #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 40, i8* %6) #2
  %7 = bitcast [10 x i32]* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %7, i8* align 16 bitcast ([10 x i32]* @main.a to i8*), i64 40, i1 false)
  ...
  %11 = getelementptr inbounds [10 x i32], [10 x i32]* %2, i64 0, i64 9
  store i32* %11, i32** %4, align 8, !tbaa !3
...
; <label>:27:                                     ; preds = %13
  ...
  %31 = bitcast [10 x i32]* %2 to i8*
  call void @llvm.lifetime.end.p0i8(i64 40, i8* %31) #2
  ret i32 0
}
