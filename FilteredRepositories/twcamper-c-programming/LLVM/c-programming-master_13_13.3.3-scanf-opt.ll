...
define i32 @main() #0 {
  ...
  %5 = getelementptr inbounds [15 x i8], [15 x i8]* %4, i32 0, i32 0
  %6 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0), i32* %2, i8* %5, i32* %3)
  %7 = load i32, i32* %2, align 4
  %8 = load i32, i32* %3, align 4
  %9 = getelementptr inbounds [15 x i8], [15 x i8]* %4, i32 0, i32 0
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i32 0, i32 0), i32 %7, i32 %8, i8* %9)
  ret i32 0
}
