; ModuleID = 'Repositories/parallella-pal/Unfiltered/pal-master_src_math_msun_src_w_drem.c'
source_filename = "Repositories/parallella-pal/Unfiltered/pal-master_src_math_msun_src_w_drem.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.14.0"

; Function Attrs: nounwind ssp uwtable
define double @drem(double, double) #0 {
  ...
  %6 = load double, double* %4, align 8, !tbaa !3
  %7 = call double @remainder(double %5, double %6) #2
  ret double %7
}
