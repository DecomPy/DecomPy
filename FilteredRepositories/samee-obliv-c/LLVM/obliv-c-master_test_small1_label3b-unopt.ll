...
; <label>:3:                                      ; preds = %0, %16
  ...
  %6 = load i8*, i8** getelementptr inbounds ([3 x i8*], [3 x i8*]* @main.array, i64 0, i64 1), align 8, !tbaa !7
  br label %16
...
; <label>:7:                                      ; preds = %16
  ...
  %10 = load i8*, i8** getelementptr inbounds ([3 x i8*], [3 x i8*]* @main.array, i64 0, i64 2), align 16, !tbaa !7
  br label %16
