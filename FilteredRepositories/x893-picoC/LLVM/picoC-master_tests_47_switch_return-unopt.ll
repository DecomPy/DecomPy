; ModuleID = 'Repositories/x893-picoC/Unfiltered/picoC-master_tests_47_switch_return.c'
source_filename = "Repositories/x893-picoC/Unfiltered/picoC-master_tests_47_switch_return.c"
...
define i32 @main() #0 {
  ...
  call void @fred(i32 1)
  call void @fred(i32 2)
  call void @fred(i32 3)
  ret i32 0
}
